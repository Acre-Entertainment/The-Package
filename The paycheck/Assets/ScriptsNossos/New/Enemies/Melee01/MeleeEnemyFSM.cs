...
{
    public class MeleeEnemyFSM : MonoBehaviour
    {
        [Header("FSM Basic")]
        [SerializeField] public State<MeleeEnemyFSM> currentState;
        ...
        public void EnterState(State<MeleeEnemyFSM> new_State)
        {
        ...
        public bool TryToAttack()
        {
            ...
            {
                m_Anim.StopPlayback();
                PlayRoutine(WaitEndOfAnimation("Punch"));
                audioPlayer.PlayClip("Attack", false, 1f);
        ...
        public void ForceChase(int damage = 0)
        {
